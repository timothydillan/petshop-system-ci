...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Snoopy <?= date('Y') ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="<?= base_url('assets/'); ?>js/fstdropdown.js">
    function setDrop() {
    ...
    var myLineChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointHitRadius: 10,
                pointBorderWidth: 2,
                data: [<?= $grooming_january ?>, <?= $grooming_february ?>, <?= $grooming_march ?>, <?= $grooming_april ?>, <?= $grooming_may ?>, <?= $grooming_june ?>, <?= $grooming_july ?>, <?= $grooming_august ?>, <?= $grooming_september ?>, <?= $grooming_october ?>, <?= $grooming_november ?>, <?= $grooming_december ?>],
            }],
        },
        options: {
