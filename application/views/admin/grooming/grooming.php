                                    ...
                                    <?php if ($g['id'] != 0) { ?>
                                        ...
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <a class="btn btn-success btn-sm btn-circle" type="button" title="Edit" href="<?= base_url() ?>admin/editgroom/<?= $g['id'] ?>"><i class="fa fa-edit"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a class="btn btn-danger btn-sm btn-circle" type="button" title="Delete" href="<?= base_url() ?>admin/deletegroom/<?= $g['id'] ?>"><i class="fa fa-trash"></i></a>
                                            </li>
                                        </ul>
                                    <?php } ?>
                                </td>
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/grooming'); ?>" method="post">
