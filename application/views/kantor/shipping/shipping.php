                                ...
                                <td>
                                    ...
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <a class="btn btn-primary btn-sm btn-circle" type="button" data-placement="top" href="<?= base_url() ?>kantor/viewshipping/<?= $s['id'] ?>" title="View"><i class="fa fa-eye"></i></a>
                                        </li>
                                        <?php
                                        if ($s['status'] == 0) {
                                        ?>
                                            <li class="list-inline-item">
                                                <a class="btn btn-success btn-sm btn-circle" type="button" data-placement="top" href="<?= base_url() ?>kantor/confirmshipping/<?= $s['id'] ?>" title="Confirm"><i class="fa fa-check"></i></a>
                                            </li>
                                        <?php } ?>
                                        <li class="list-inline-item">
                                            <a class="btn btn-danger btn-sm btn-circle" type="button" data-placement="top" href="<?= base_url() ?>kantor/deleteshipping/<?= $s['id'] ?>" title="Delete"><i class="fa fa-trash"></i></a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
...
<div class="modal fade" id="addMemberModal" tabindex="-1" role="dialog" aria-labelledby="addMemberModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('kantor/shipping'); ?>" method="post">
